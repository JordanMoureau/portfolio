...
function bigFiveOut() {
  ...
  document.getElementById("bigFive").style.backgroundImage = "url(images/inayearsite-01.png)";
}
...
function littleOneMask() {
  ...
  document.getElementById("littleOne").style.backgroundSize= "contain";
}

function littleOneOut() {
  document.getElementById("littleOne").style.gridArea = "1 / 3 / 1 / 3";
document.getElementById("littleOne").style.backgroundImage = "url(images/INAYEAR.png)";
...
const heroAction = setTimeout(heroFlip, 9000);
